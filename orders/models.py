...
class Order(models.Model):
    ...
    managers = models.ManyToManyField(CustomUser, related_name='order_manager', verbose_name='Ответственный')
    ...
    status_pay = models.CharField(choices=TYPE_STATUS_PAY, default=NOT_PAID,verbose_name='Статус оплаты')
    status_documents = models.CharField(choices=TYPE_STATUS_DOCUMENTS, default=NOT_SENT, verbose_name='Статус документов')
