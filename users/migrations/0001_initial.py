    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=24, null=True, verbose_name='Телефон')),
                ('photo', models.ImageField(blank=True, default='media/users/use.png', upload_to='midia/users/%Y/%m/%d/', verbose_name='Аватар')),
                ...
                ('type', models.CharField(choices=[('AD', 'Администратор'), ('OA', 'Менеджер'), ('CL', 'Клиент'), ('OO', 'Клиент менеджер')], default='CL', max_length=6, verbose_name='Тип пользователя')),
